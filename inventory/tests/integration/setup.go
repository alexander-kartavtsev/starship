...
import (
	...
	"github.com/alexander-kartavtsev/starship/platform/pkg/testcontainers"
	"github.com/alexander-kartavtsev/starship/platform/pkg/testcontainers/app"
	"github.com/alexander-kartavtsev/starship/platform/pkg/testcontainers/mongo"
	"github.com/alexander-kartavtsev/starship/platform/pkg/testcontainers/network"
	"github.com/alexander-kartavtsev/starship/platform/pkg/testcontainers/path"
)

const (
	// Параметры для контейнеров
	inventoryAppName    = "inventory-app"                      //nolint:gosec
	inventoryDockerfile = "deploy/docker/inventory/Dockerfile" //nolint:gosec

	// Переменные окружения приложения
	grpcPortKey = "GRPC_PORT" //nolint:gosec

	// Значения переменных окружения
	loggerLevelValue = "debug"         //nolint:gosec
	startupTimeout   = 3 * time.Minute //nolint:gosec
)
