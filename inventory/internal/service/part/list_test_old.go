...
func TestService_List_old(t *testing.T) {
	type inventoryServiceMockFunk func(t *testing.T) *repoMocks.InventoryRepository

	allTestParts := converter.PartsToModel(getAllPartsOld())

	servMockFunk := func(t *testing.T) *repoMocks.InventoryRepository {
		mockRepo := repoMocks.NewInventoryRepository(t)
		mockRepo.
			On("List", context.Background()).
			Return(allTestParts, nil).
			Once()
		return mockRepo
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			inventoryServiceMockFunk: servMockFunk,
		},
		{
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			res, err := serv.List(context.Background(), test.param)
...
func TestConverter_PartsToModel_old(t *testing.T) {
...
func getAllPartsOld() map[string]repoModel.Part {
