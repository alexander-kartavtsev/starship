...
func (_m *InventoryClient) ListParts(ctx context.Context, filter model.PartsFilter) (map[string]model.Part, error) {
...
func (_c *InventoryClient_ListParts_Call) Return(_a0 map[string]model.Part, _a1 error) *InventoryClient_ListParts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *InventoryClient_ListParts_Call) RunAndReturn(run func(context.Context, model.PartsFilter) (map[string]model.Part, error)) *InventoryClient_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
