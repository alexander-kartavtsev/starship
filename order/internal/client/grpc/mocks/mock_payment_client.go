...
func (_m *PaymentClient) PayOrder(ctx context.Context, req model.PayOrderRequest) (string, error) {
...
func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, req model.PayOrderRequest)) *PaymentClient_PayOrder_Call {
...
func (_c *PaymentClient_PayOrder_Call) RunAndReturn(run func(context.Context, model.PayOrderRequest) (string, error)) *PaymentClient_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
