...
func (_m *OrderRepository) Update(ctx context.Context, uuid string, updateInfo model.OrderUpdateInfo) error {
...
func (_c *OrderRepository_Update_Call) Run(run func(ctx context.Context, uuid string, updateInfo model.OrderUpdateInfo)) *OrderRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OrderRepository_Update_Call) RunAndReturn(run func(context.Context, string, model.OrderUpdateInfo) error) *OrderRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
